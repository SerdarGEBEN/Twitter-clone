    ...
    <nav className="flex flex-col justify-between items-end px-2 py-4">
      <div>
        ...
        {navSections.map((i, key) => (
          <div
            key={key}
            className="flex items-center gap-3 text-2xl md:text-xl p-3 cursor-pointer rounded-e-lg
          transition hover:bg-[#505050b7] max-md:justify-center"
          >
            {i.icon}
        ...
        {!user ? (
          ...
          <div className="flex flex-col gap-5">
            ...
            <button
              ...
              className="flex justify-center items-center gap-2 text-xl md:text[16px] p-1
             bg-zinc-700 rounded transition over:bg-zinc-900"
            >
              <BiSolidDoorOpen />
