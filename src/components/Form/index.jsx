...
const Form = ({ user }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    //2) yazı ve resim içeriği yoksa fonk durur
    if (!text && !image) {
    ...
    try {
      ...
      //4.1) kolleksiyon referansını al
  ...
  return (
    ...
    >
      ...
      <div className="w-full ">
        <input
          className="w-full mt-1 bg-transparent outline-none md:text-lg"
        ...
        <div className="flex justify-between items-center">
          ...
          <button></button>
          <button
            className="bg-blue-400 px-3 py-2 mşn-w-[85px]
